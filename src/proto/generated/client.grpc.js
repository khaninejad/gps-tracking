...
$root.gps = (function() {
    ...
    gps.GpsService = (function() {
        ...
        (GpsService.prototype = Object.create($protobuf.rpc.Service.prototype)).constructor = GpsService;
         ...
         */
        GpsService.create = function create(rpcImpl, requestDelimited, responseDelimited) {
         ...
         * @variation 1
         */
        Object.defineProperty(GpsService.prototype.sendGpsData = function sendGpsData(request, callback) {
            return this.rpcCall(sendGpsData, $root.gps.GpsData, $root.gps.GpsResponse, request, callback);
        }, "name", { value: "SendGpsData" });
    ...
    gps.GpsData = (function() {
         ...
         * @instance
         */
        GpsData.prototype.timestamp = $util.Long ? $util.Long.fromBits(0,0,false) : 0;
        ...
        GpsData.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.gps.GpsData();
        ...
        GpsData.fromObject = function fromObject(object) {
            if (object instanceof $root.gps.GpsData)
                return object;
    ...
    gps.GpsResponse = (function() {
        ...
        GpsResponse.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.gps.GpsResponse();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        GpsResponse.fromObject = function fromObject(object) {
            if (object instanceof $root.gps.GpsResponse)
                return object;
