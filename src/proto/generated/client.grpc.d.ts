...
export namespace gps {
  ...
  class GpsService extends $protobuf.rpc.Service {
     ...
     */
    public sendGpsData(
      request: gps.IGpsData,
      callback: gps.GpsService.SendGpsDataCallback
    ): void;
  ...
  namespace GpsService {
     ...
     */
    type SendGpsDataCallback = (
      error: Error | null,
      response?: gps.GpsResponse
    ) => void;
  }
